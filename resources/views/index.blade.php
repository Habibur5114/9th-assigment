        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a href="#intro" class="nav-link smoothScroll">Home</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="#testimonials" class="nav-link smoothScroll">Review</a>
                    </li>
         ...
         <div class="container">
            <div class="row">
                  ...
                  <div class="mx-auto col-lg-5 col-md-5 col-10">
                      <img src="front/images/ben.jpg" class="img-fluid" alt="Ben Resume HTML Template"> 
    ...
    <section class="about section-padding" id="about">
        <div class="container">
            <div class="row">
                ...
                <img src="front/images/true-agency.jpg" class="about-image img-fluid" alt="Ben's Resume HTML Template">
                </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="owl-carousel owl-theme" id="testimonials-carousel">
                            ...
                            <div class="item">
                                <div class="testimonials-thumb d-flex">
                                    <div class="testimonials-image">
                                        <img src="images/testimonials/testimonial-image04.jpg" 
                                        
                                        class="img-fluid" alt="testimonials image">
                                    </div>
